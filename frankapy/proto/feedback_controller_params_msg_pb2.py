...
_CARTESIANIMPEDANCEFEEDBACKCONTROLLERMESSAGE = DESCRIPTOR.message_types_by_name['CartesianImpedanceFeedbackControllerMessage']
_FORCEAXISFEEDBACKCONTROLLERMESSAGE = DESCRIPTOR.message_types_by_name['ForceAxisFeedbackControllerMessage']
_JOINTIMPEDANCEFEEDBACKCONTROLLERMESSAGE = DESCRIPTOR.message_types_by_name['JointImpedanceFeedbackControllerMessage']
_INTERNALIMPEDANCEFEEDBACKCONTROLLERMESSAGE = DESCRIPTOR.message_types_by_name['InternalImpedanceFeedbackControllerMessage']
_FORCEPOSITIONFEEDBACKCONTROLLERMESSAGE = DESCRIPTOR.message_types_by_name['ForcePositionFeedbackControllerMessage']
