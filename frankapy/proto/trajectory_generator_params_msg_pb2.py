...
_GRIPPERTRAJECTORYGENERATORMESSAGE = DESCRIPTOR.message_types_by_name['GripperTrajectoryGeneratorMessage']
_IMPULSETRAJECTORYGENERATORMESSAGE = DESCRIPTOR.message_types_by_name['ImpulseTrajectoryGeneratorMessage']
_JOINTTRAJECTORYGENERATORMESSAGE = DESCRIPTOR.message_types_by_name['JointTrajectoryGeneratorMessage']
_JOINTVELOCITYTRAJECTORYGENERATORMESSAGE = DESCRIPTOR.message_types_by_name['JointVelocityTrajectoryGeneratorMessage']
_POSETRAJECTORYGENERATORMESSAGE = DESCRIPTOR.message_types_by_name['PoseTrajectoryGeneratorMessage']
_JOINTDMPTRAJECTORYGENERATORMESSAGE = DESCRIPTOR.message_types_by_name['JointDMPTrajectoryGeneratorMessage']
_POSEDMPTRAJECTORYGENERATORMESSAGE = DESCRIPTOR.message_types_by_name['PoseDMPTrajectoryGeneratorMessage']
_QUATERNIONPOSEDMPTRAJECTORYGENERATORMESSAGE = DESCRIPTOR.message_types_by_name['QuaternionPoseDMPTrajectoryGeneratorMessage']
_RUNTIMEMESSAGE = DESCRIPTOR.message_types_by_name['RunTimeMessage']
...
JointVelocityTrajectoryGeneratorMessage = _reflection.GeneratedProtocolMessageType('JointVelocityTrajectoryGeneratorMessage', (_message.Message,), {
  'DESCRIPTOR' : _JOINTVELOCITYTRAJECTORYGENERATORMESSAGE,
  '__module__' : 'trajectory_generator_params_msg_pb2'
  # @@protoc_insertion_point(class_scope:JointVelocityTrajectoryGeneratorMessage)
  })
_sym_db.RegisterMessage(JointVelocityTrajectoryGeneratorMessage)
